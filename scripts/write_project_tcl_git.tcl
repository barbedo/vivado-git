...
#
#   2. When recreating a project, the generated files will be put in a "work" directory
#      under the project directory. If the work exists already, it will be rewritten.
#
